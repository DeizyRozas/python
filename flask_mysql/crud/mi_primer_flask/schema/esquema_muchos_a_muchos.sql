...
-- -----------------------------------------------------
-- Table `login_reg`.`users_has_toppings`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `login_reg`.`users_has_toppings` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `topping_id` INT NOT NULL,
  `burger_id` INT NOT NULL,
  INDEX `fk_users_has_toppings_toppings1_idx` (`topping_id` ASC) VISIBLE,
  INDEX `fk_users_has_toppings_burgers1_idx` (`burger_id` ASC) VISIBLE,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_users_has_toppings_toppings1`
    FOREIGN KEY (`topping_id`)
    REFERENCES `login_reg`.`toppings` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_has_toppings_burgers1`
